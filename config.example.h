...
//        check the quick install guides!!! Some of these boards require a
//        voltage generating resistor on the current sense pin of the device.
//        Failure to select the correct resistor could damage the sense pin on
//        your Arduino or destroy the device.
//
// DEFINE MOTOR_SHIELD_TYPE BELOW. THESE ARE EXAMPLES. FULL LIST IN
// MotorDrivers.h
//
//  STANDARD_MOTOR_SHIELD : Arduino Motor shield Rev3 based on the L298 with 18V
//  2A per channel POLOLU_MOTOR_SHIELD   : Pololu MC33926 Motor Driver (not
//  recommended for prog track) FUNDUMOTO_SHIELD      : Fundumoto Shield, no
//  current sensing (not recommended, no short protection) FIREBOX_MK1 : The
//  Firebox MK1 FIREBOX_MK1S          : The Firebox MK1S IBT_2_WITH_ARDUINO    :
//  Arduino Motor Shield for PROG and IBT-2 for MAIN EX8874_SHIELD         :
...
// this line exists or not. If you need to use an alternate channel (we
// recommend using only 1,6, or 11) you may change it here.
#define WIFI_CHANNEL 1
//
// WIFI_FORCE_AP: If you'd like to specify your own WIFI_SSID in AP mode, set
// this true. Otherwise it is assumed that you'd like to connect to an existing
// network with that SSID.
#define WIFI_FORCE_AP false

/////////////////////////////////////////////////////////////////////////////////////
//
// ENABLE_ETHERNET: Set to true if you have an Arduino Ethernet card (wired).
...
// OR define OLED_DRIVER width,height[,address] in pixels (address auto detected
// if not supplied)
...
// DISABLE PROG
//
// If you do not need programming capability, you can disable all programming
// related commands. You might want to do that if you are using an Arduino UNO
// and still want to use EXRAIL automation, as the Uno is lacking in RAM and
// Flash to run both.
//
...
/////////////////////////////////////////////////////////////////////////////////////
// REDEFINE WHERE SHORT/LONG ADDR break is. According to NMRA the last short
// address is 127 and the first long address is 128. There are manufacturers
// which have another view. Lenz CS for example have considered addresses long
// from 100. If you want to change to that mode, do
...
// We do not support to use the same address, for example 100(long) and
// 100(short) at the same time, there must be a border.
...
// Other serial throttles may be added to the Serial1, Serial2, Serial3,
// Serial4, Serial5, and Serial6 ports which may or may not exist on your CPU.
// (Mega has 3, SAMD/SAMC and STM32 have up to 6.) To monitor a throttle on one
// or more serial ports, uncomment the defines below. NOTE: do not define here
// the WiFi shield serial port or your wifi will not work.
//
...
//    may suffer
// 2. The app will be bigger that 1.2MB, so the default partition scheme will
// not
