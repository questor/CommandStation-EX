  ...
  for (int i = 0;; ++i) {
    ...
    do {
      ...
      case 'd':
        ...
        break;
      case 'u':
        printPadded(stream, va_arg(args, unsigned int), formatWidth,
                    formatLeft);
        break;
      case 'l':
      ...
      case 'X':
        ...
        break;
      case 'M': { // this prints a unsigned long microseconds time in readable
                  // format
...
void StringFormatter::printEscape(char c) { printEscape(&USB_SERIAL, c); }
