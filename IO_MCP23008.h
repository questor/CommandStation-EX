...
private:
  // Constructor
  MCP23008(VPIN firstVpin, uint8_t nPins, I2CAddress i2cAddress,
           int interruptPin = -1)
      : GPIOBase<uint8_t>((FSH *)F("MCP23008"), firstVpin, nPins, i2cAddress,
                          interruptPin) {
  ...
  void _setupDevice() override {
    // IOCON is set ODR=1 (open drain shared interrupt pin), INTPOL=0
    // (active-Low)
