...
/*
 * The IO_EXFastclock device driver is used to interface the standalone fast
 * clock and receive time data.
 *
 * The EX-fastClock code lives in a separate repo
 * (https://github.com/DCC-EX/EX-Fastclock) and contains the clock logic.
 *
 *
 */
...
private:
  ...
  void _display() override {
    DIAG(F("FastCLock on I2C:%s - %S"), _I2CAddress.toString(),
