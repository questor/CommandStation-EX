...
// Note: WIFI_CHANNEL may not exist in early config.h files so is added here if
// needed.
...
////////////////////////////////////////////////////////////////////////////////
//
// This defines the speed at which the Arduino will communicate with the ESP8266
// module. Currently only devices which can communicate at 115200 are supported.
//
#define WIFI_SERIAL_LINK_SPEED 115200

#if __has_include("myAutomation.h")
#if defined(HAS_ENOUGH_MEMORY) || defined(DISABLE_EEPROM) ||                   \
    defined(DISABLE_PROG)
