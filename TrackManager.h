...
// These constants help EXRAIL macros say SET_TRACK(2,mode) OR SET_TRACK(C,mode)
// etc.
...
class TrackManager {
public:
  static void Setup(const FSH *shieldName, MotorDriver *track0,
                    MotorDriver *track1 = NULL, MotorDriver *track2 = NULL,
                    MotorDriver *track3 = NULL, MotorDriver *track4 = NULL,
                    MotorDriver *track5 = NULL, MotorDriver *track6 = NULL,
  ...
  static bool
      progTrackSyncMain; // true when prog track is a siding switched to main
...
private:
  ...
  static int16_t
      trackDCAddr[MAX_TRACKS]; // dc address if TRACK_MODE_DC or TRACK_MODE_DCX
#ifdef ARDUINO_ARCH_ESP32
